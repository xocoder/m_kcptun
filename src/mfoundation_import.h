...
#define M_FOUNDATION_IMPORT_MODEL_GF (M_FOUNDATION_IMPORT_MODEL_MEM)

#define M_FOUNDATION_IMPORT_MODEL_RS (M_FOUNDATION_IMPORT_MODEL_MEM && \
                                      M_FOUNDATION_IMPORT_MODEL_GF)
